...
g++ -c backup.cpp -o backup.o
g++ -c modeApplication.cpp -o modeApplication.o
g++ -c main.cpp -o main.o
g++ authenticator.o definedTime.o file.o user.o course.o user_function.o homework.o backup.o modeApplication.o main.o -o myprogram 
