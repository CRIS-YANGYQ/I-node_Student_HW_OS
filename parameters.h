...
const std::string userTablePath = "userTable.csv";
const std::string requestTablePath = "requestsTable.csv";
...
#define MAX_USER_NUMBER 50
#define MAX_REQUEST_NUMBER 100
#define MAX_SELECTION_NUMBER 300
#define MAX_BACKUP_NUMBER 50
# endif
